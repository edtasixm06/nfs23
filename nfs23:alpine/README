...
```
$ docker run --rm --name nfsa -h nfsa --net mynet --privileged -v data-nfs-deb:/export -it edtasixm06/nfs23:alpine /bin/sh
...
```
[ecanet@mylaptop]$ docker run --rm --name nfsa -h nfsa --net mynet --privileged -v data-nfs-deb:/export -d edtasixm06/nfs23:alpine 
93e42f317a2e456fc52c0c5a9cd55abbc15fde738f99034bd60bcc0cd609422f

[ecanet@mylaptop]$ docker ps
CONTAINER ID   IMAGE                     COMMAND                  CREATED          STATUS          PORTS     NAMES
93e42f317a2e   edtasixm06/nfs23:alpine   "/bin/sh -c /opt/doc…"   10 seconds ago   Up 10 seconds             nfsa

[ecanet@mylaptop]$ docker stop nfsa 
nfsa
```
